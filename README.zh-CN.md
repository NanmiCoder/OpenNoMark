...
下面展示的是仓库中的真实文件，而不是设计效果图。第一排为原图，第二排为对应的 OpenNoMark 输出。

### Gemini · 星芒图标

| 原图 | 原图 | 原图 |
| :---: | :---: | :---: |
| ![Gemini 原始样例 1](examples/gemini/gemini_sample_1.png) | ![Gemini 原始样例 2](examples/gemini/gemini_sample_2.png) | ![Gemini 原始样例 3](examples/gemini/gemini_sample_3.png) |
| **处理后** | **处理后** | **处理后** |
| ![Gemini 处理后样例 1](examples/gemini/clean_gemini_sample_1.png) | ![Gemini 处理后样例 2](examples/gemini/clean_gemini_sample_2.png) | ![Gemini 处理后样例 3](examples/gemini/clean_gemini_sample_3.png) |

### 豆包 · “AI 生成”标签

| 原图 | 原图 | 原图 |
| :---: | :---: | :---: |
| ![豆包原始样例 1](examples/doubao/doubao_sample_1.jpg) | ![豆包原始样例 2](examples/doubao/doubao_sample_2.jpg) | ![豆包原始样例 3](examples/doubao/doubao_sample_3.jpg) |
| **处理后** | **处理后** | **处理后** |
| ![豆包处理后样例 1](examples/doubao/clean_doubao_sample_1.jpg) | ![豆包处理后样例 2](examples/doubao/clean_doubao_sample_2.jpg) | ![豆包处理后样例 3](examples/doubao/clean_doubao_sample_3.jpg) |
